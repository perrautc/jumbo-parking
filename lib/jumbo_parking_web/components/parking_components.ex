defmodule JumboParkingWeb.ParkingComponents do
  ...
  defp nav_icon(%{name: "building"} = assigns) do
    ~H"""
    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  defp nav_icon(%{name: "user-group"} = assigns) do
    ~H"""
    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  defp nav_icon(%{name: "shopping-bag"} = assigns) do
    ~H"""
    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  def user_group_icon(assigns) do
    ~H"""
